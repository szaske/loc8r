...
open class BaseTestRobot {
    ...
    fun matchErrorText(resId: Int, text: String): ViewInteraction = matchErrorText(textView(resId), text)
    ...
    fun matchNotErrorText(resId: Int, text: String): ViewInteraction = matchErrorText(textView(resId), text)
